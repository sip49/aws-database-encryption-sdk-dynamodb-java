...
public class TableSchemaBuilderPutGetExample {
    public static void PutItemGetItem(String kmsKeyId, String ddbTableName) {
        ...
        try (DynamoDbClient noEncryptionDdb = DynamoDbClient.builder().build()) {
            ...
            assertManipulationProof(itemEncryptor, manipulateByteAttribute(itemDecrypted, "attribute1"), "attribute1");
            assertManipulationProof(itemEncryptor, manipulateStringAttribute(itemDecrypted, "attribute2"), "attribute2");
            assertNotManipulationProof(itemEncryptor, manipulateStringAttribute(itemDecrypted, ":attribute3"), ":attribute3");
        } catch (IOException e) {
